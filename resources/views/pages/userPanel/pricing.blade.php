            ...
            <div class="d-flex justify-content-center">
                <ul class="nav nav-pills nav-primary mb-10 mb-lg-20 bg-white rounded" id="pills-tab" role="tablist">
                    <li class="nav-item p-0 m-0">
                        <a class="nav-link active font-weight-bolder rounded-right-0 px-8 py-5" id="pills-tab-1" data-toggle="pill" href="#kt-pricing-2_content1" aria-expanded="true" aria-controls="kt-pricing-2_content1">Abonamente Lunar</a>
                    </li>
                    <li class="nav-item p-0 m-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 border-x-0 border-x-md border-y border-y-md-0">
                                <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                                    ...
                                    <div class="d-flex flex-column line-height-xl mb-10">
                                        <span>3 Persoana</span>
                                        <span>Retete online</span>
                                        <span>Chat live cu doctorii</span>
                                    </div>
                                    <span class="font-size-h1 d-block font-weight-boldest text-dark">200
																<sup class="font-size-h3 font-weight-normal pl-1">ron</sup></span>
                                    <div class="mt-7">
                                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
                                            <button type="button" class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">Purchase</button>
                                        </a>
                            ...
                            <div class="col-md-4">
                                <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                                    ...
                                    <h4 class="font-size-h3 mb-10">Psihonic Nuclear Family</h4>
                                    <div class="d-flex flex-column line-height-xl mb-10">
                                        <span>6 Persoane</span>
                                        <span>Retete online</span>
                                        <span>Chat live cu doctorii</span>
                                    </div>
                                    <span class="font-size-h1 d-block font-weight-boldest text-dark">380
																<sup class="font-size-h3 font-weight-normal pl-1">ron</sup></span>
                                    <div class="mt-7">
                                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
                                            <button type="button" class="btn btn-primary text-uppercase font-weight-bolder px-15 py-3">Purchase</button>
